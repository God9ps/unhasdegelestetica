    ...
    <div id="main_area">
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                ...
                <p class="section-title" style="font-size: 24px">Unhas de Gel</p>
            </div> <!-- /.col-md-12 -->
            <div class="col-sm-6 hidden-xs" id="slider-thumbs">
                ...
                <ul class="hide-bullets">
                    ...
                    <li class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-0"><img src="images/galeria/unhasdegel/thumbs/unhasdegel/Unhas-de-gel-1.jpg"></a>
                    </li>

                    <li class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-1"><img src="images/galeria/unhasdegel/thumbs/unhasdegel/Unhas-de-gel-2.jpg"></a>
                    </li>

                    <li class="col-sm-3">
                        <a class="thumbnail" id="carousel-selector-2"><img src="images/galeria/unhasdegel/thumbs/unhasdegel/Unhas-de-gel-3.jpg"></a>
                    </li>
                            ...
                            <div class="carousel slide" id="myCarousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="active item" data-slide-number="0">
                                        <img src="images/galeria/unhasdegel/unhas-de-gel-1.jpg">
                                        <div class="gallery-item">Unhas de Gel</div>
                                    </div>

                                    <div class="item" data-slide-number="1">
                                        <img src="images/galeria/unhasdegel/unhas-de-gel-2.jpg">
                                        <div class="gallery-item">Unhas de Gel</div>
                                    </div>

                                    <div class="item" data-slide-number="2">
                                        <img src="images/galeria/unhasdegel/unhas-de-gel-3.jpg">
                                        <div class="gallery-item">Unhas de Gel</div>
                                    </div>
